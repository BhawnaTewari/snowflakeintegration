--------------------------------------------------------
-- DATABASE CREATION (DEV ENV ONLY)
--------------------------------------------------------
...
-- Allow the owner role to manage grants
USE ROLE SECURITYADMIN;
...
--------------------------------------------------------
-- TASKADMIN ROLE & TASK PRIVILEGES (IDEMPOTENT)
--------------------------------------------------------
...
GRANT USAGE ON WAREHOUSE CDA_WH_XS TO ROLE DEV_GW_CDA_CDA_PC_RAW_READ;
GRANT USAGE ON WAREHOUSE CDA_WH_XS TO ROLE DEV_GW_CDA_CDA_PC_RAW_WRITE;
GRANT USAGE ON WAREHOUSE CDA_WH_XS TO ROLE DEV_GW_CDA_CDA_PC_MERGED_READ;
GRANT USAGE ON WAREHOUSE CDA_WH_XS TO ROLE DEV_GW_CDA_CDA_PC_MERGED_WRITE;
GRANT USAGE ON WAREHOUSE CDA_WH_XS TO ROLE DEV_GW_CDA_CDA_ABC_SHARED_READ;
GRANT USAGE ON WAREHOUSE CDA_WH_XS TO ROLE DEV_GW_CDA_CDA_ABC_SHARED_WRITE;
